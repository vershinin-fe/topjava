        ...
        switch (action == null ? "all" : action) {
            ...
            default:
                ...
                request.setAttribute("meals", mealController.getFiltered(
                                ...
                                request.getParameter("minTime"),
                                request.getParameter("maxTime"))
                );

                request.setAttribute("minDate", request.getParameter("minDate"));
                request.setAttribute("maxDate", request.getParameter("maxDate"));
                request.setAttribute("minTime", request.getParameter("minTime"));
                request.setAttribute("maxTime", request.getParameter("maxTime"));
