...
public class MealsUtil {
    public static final List<Meal> MEALS_SARAH = Arrays.asList(
    ...
    public static final List<Meal> MEALS_ALICE = Arrays.asList(
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 510),
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 900),
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 520),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1010),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 501),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 470)
    );
